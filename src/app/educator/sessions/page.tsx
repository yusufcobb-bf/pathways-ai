/**
 * Stage 42: Educator Sessions Page
 *
 * Displays all student sessions with expandable details.
 * Moved from main educator dashboard for cleaner navigation.
 */
...
import { getVariantTitle, getVariantDisplayInfo } from "@/data/variants";
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-zinc-600">
            Review student story completions, choices, and virtue outcomes.
          </p>
        </div>
        <Link
          href="/educator"
